...
@Component({
  selector: 'ngx-workorder-list-closed',
  styleUrls: ['./workorder-list-closed.component.scss'],
  templateUrl: './workorder-list-closed.component.html',
})

export class WorkOrderListClosedComponent implements OnInit {
