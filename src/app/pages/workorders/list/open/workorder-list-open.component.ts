...
@Component({
  selector: 'ngx-workorder-list-open',
  styleUrls: ['./workorder-list-open.component.scss'],
  templateUrl: './workorder-list-open.component.html',
})

export class WorkOrderListOpenComponent implements OnInit {
